...
export const productionConfig: Config = {
  ...
  // redis config for content moderation queue
  REDIS_CONTENT_MODERATION_NOTIFICATION_HOST: String(process.env.REDIS_CONTENT_MODERATION_NOTIFICATION_HOST),
  REDIS_CONTENT_MODERATION_NOTIFICATION_PORT: Number(process.env.REDIS_CONTENT_MODERATION_NOTIFICATION_PORT),
  REDIS_CONTENT_MODERATION_NOTIFICATION_USER: String(process.env.REDIS_CONTENT_MODERATION_NOTIFICATION_USER),
  REDIS_CONTENT_MODERATION_NOTIFICATION_PASS: String(process.env.REDIS_CONTENT_MODERATION_NOTIFICATION_PASS),
  // redis config for university notification queue
  REDIS_UNIVERSITY_NOTIFICATION_HOST: String(process.env.REDIS_UNIVERSITY_NOTIFICATION_HOST),
  REDIS_UNIVERSITY_NOTIFICATION_PORT: Number(process.env.REDIS_UNIVERSITY_NOTIFICATION_PORT),
  REDIS_UNIVERSITY_NOTIFICATION_USER: String(process.env.REDIS_UNIVERSITY_NOTIFICATION_USER),
  REDIS_UNIVERSITY_NOTIFICATION_PASS: String(process.env.REDIS_UNIVERSITY_NOTIFICATION_PASS),
  server: {
